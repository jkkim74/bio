...
public class BioRithm {
    ...
    public void displayPieChart(String birthDay, Date today) {
        ...
        // System.out.println(mapSinRslt.toString());
        //caloutput(2020,1);
//        float valueEmotional    =  getBiorhythm(birthDay, today, VALUE_OF_BIORHYTHM_EMOTIONAL);
//        float valueIntellectual = getBiorhythm(birthDay, today, VALUE_OF_BIORHYTHM_INTELLECTUAL);
//        System.out.println("육체지수 : "+valuePhysical);
//        System.out.println("감정지수 : "+valueEmotional);
//        System.out.println("지적지수 : "+valueIntellectual);
        //drawPieChart(pieChartOfPhysical , valuePhysical);
        //drawPieChart(pieChartOfEmotional , valueEmotional);
        //drawPieChart(pieChartOfIntellectual , valueIntellectual);

        //setPieData(pieChartOfPhysical , valuePhysical     , Color.rgb(137,165,78), Color.rgb(94,110,73));
        //setPieData(pieChartOfEmotional , valueEmotional    , Color.rgb(68,113,168), Color.rgb(59,86,116));
        //setPieData(pieChartOfIntellectual , valueIntellectual , Color.rgb(128,103,233), Color.rgb(89,79,150));
    }
